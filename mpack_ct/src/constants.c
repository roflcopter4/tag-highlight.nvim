...
struct ftdata_s ftdata[] = {
    { NULL, NULL, NULL, BI("NONE"),       BI("NONE"),       FT_NONE,       0 },
    { NULL, NULL, NULL, BI("c"),          BI("c"),          FT_C,          0 },
    { NULL, NULL, NULL, BI("cpp"),        BI("c++"),        FT_CPP,        0 },
    { NULL, NULL, NULL, BI("cs"),         BI("csharp"),     FT_CSHARP,     0 },
    { NULL, NULL, NULL, BI("go"),         BI("go"),         FT_GO,         0 },
    { NULL, NULL, NULL, BI("java"),       BI("java"),       FT_JAVA,       0 },
    { NULL, NULL, NULL, BI("javascript"), BI("javascript"), FT_JAVASCRIPT, 0 },
    { NULL, NULL, NULL, BI("lisp"),       BI("lisp"),       FT_LISP,       0 },
    { NULL, NULL, NULL, BI("perl"),       BI("perl"),       FT_PERL,       0 },
    { NULL, NULL, NULL, BI("php"),        BI("php"),        FT_PHP,        0 },
    { NULL, NULL, NULL, BI("python"),     BI("python"),     FT_PYTHON,     0 },
    { NULL, NULL, NULL, BI("ruby"),       BI("ruby"),       FT_RUBY,       0 },
    { NULL, NULL, NULL, BI("rust"),       BI("rust"),       FT_RUST,       0 },
    { NULL, NULL, NULL, BI("sh"),         BI("sh"),         FT_SHELL,      0 },
    { NULL, NULL, NULL, BI("vim"),        BI("vim"),        FT_VIM,        0 },
    { NULL, NULL, NULL, BI("zsh"),        BI("zsh"),        FT_ZSH,        0 },
};
