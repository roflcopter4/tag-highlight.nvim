if !exists('g:tag_highlight#go#order')
        let g:tag_highlight#go#order = "pftsicmvF"
endif
...
let g:tag_highlight#go#F = { 'group': 'goMethodTag', }
...
highlight def link goPackageTag		tag_highlight_NamespaceTag
...
highlight def link goMethodTag		tag_highlight_MethodTag
